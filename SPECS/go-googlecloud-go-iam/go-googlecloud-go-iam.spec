...
Source0:        https://github.com/googleapis/google-cloud-go/archive/refs/tags/iam/v1.11.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n google-cloud-go-iam-v1.11.0
...
Provides:       go(cloud.google.com/go/iam/admin/apiv1) = %{version}
Provides:       go(cloud.google.com/go/iam/admin/apiv1/adminpb) = %{version}
Provides:       go(cloud.google.com/go/iam/apiv1) = %{version}
Provides:       go(cloud.google.com/go/iam/apiv1/iampb) = %{version}
Provides:       go(cloud.google.com/go/iam/apiv2) = %{version}
Provides:       go(cloud.google.com/go/iam/apiv2/iampb) = %{version}
Provides:       go(cloud.google.com/go/iam/apiv3) = %{version}
Provides:       go(cloud.google.com/go/iam/apiv3/iampb) = %{version}
Provides:       go(cloud.google.com/go/iam/apiv3beta) = %{version}
Provides:       go(cloud.google.com/go/iam/apiv3beta/iampb) = %{version}
Provides:       go(cloud.google.com/go/iam/credentials/apiv1) = %{version}
Provides:       go(cloud.google.com/go/iam/credentials/apiv1/credentialspb) = %{version}
Provides:       go(cloud.google.com/go/iam/internal) = %{version}
...
# package visibility rules are preserved.
