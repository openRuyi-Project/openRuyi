...
# github.com/youtube/vitess import path and is unrelated to the libraries. The KT
...
# Legacy tests trigger vet checks for formatting, lock copies, and Fatalf
# calls from worker goroutines; retain their execution without vet.
...
# Compile the KT tests without starting the external Kyoto Tycoon servers.
%check -a
