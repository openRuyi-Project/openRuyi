...
Source0:        https://github.com/xanzy/ssh-agent/archive/refs/tags/v0.3.3.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
...
BuildRequires:  go(golang.org/x/crypto/ssh/agent)

Provides:       go(github.com/xanzy/ssh-agent) = %{version}

Requires:       go(golang.org/x/crypto)
Requires:       go(golang.org/x/crypto/ssh/agent)
