...
%define _name           stdoutmetric
%define go_import_path  go.opentelemetry.io/otel/exporters/stdout/stdoutmetric
%define go_source_subdir exporters/stdout/stdoutmetric

Name:           go-opentelemetry-otel-exporters-stdout-stdoutmetric
Version:        1.43.0
Release:        %autorelease
Summary:        Stdout metric exporter for OpenTelemetry Go
License:        Apache-2.0
URL:            https://github.com/open-telemetry/opentelemetry-go
#!RemoteAsset:  sha256:860b10657e379aec336d731ed1a9dd51d4aedfd699d02d2da82699cb211adcf1
Source0:        https://github.com/open-telemetry/opentelemetry-go/archive/refs/tags/exporters/stdout/stdoutmetric/v1.43.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-go-exporters-stdout-stdoutmetric-v1.43.0
...
Provides:       go(go.opentelemetry.io/otel/exporters/stdout/stdoutmetric/internal) = %{version}
Provides:       go(go.opentelemetry.io/otel/exporters/stdout/stdoutmetric/internal/counter) = %{version}
Provides:       go(go.opentelemetry.io/otel/exporters/stdout/stdoutmetric/internal/observ) = %{version}
Provides:       go(go.opentelemetry.io/otel/exporters/stdout/stdoutmetric/internal/x) = %{version}
...
Requires:       go(go.opentelemetry.io/otel/sdk/metric/metricdata)
...
%description
This package provides Stdout metric exporter for OpenTelemetry Go.
...
%files
%doc exporters/stdout/stdoutmetric/README.md
%license LICENSE
