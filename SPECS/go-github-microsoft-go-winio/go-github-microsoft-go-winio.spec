...
Source0:        https://github.com/Microsoft/go-winio/archive/refs/tags/v0.6.2.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n go-winio-0.6.2
...
%description
This package provides Windows I/O library for Go.
