...
Version:        1.4.0
Release:        %autorelease
Summary:        A Go module implementing support for decimal128 values.
...
Source0:        https://github.com/woodsbury/decimal128/archive/refs/tags/v1.4.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
