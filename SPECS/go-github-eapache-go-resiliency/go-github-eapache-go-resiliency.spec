...
Provides:       go(github.com/eapache/go-resiliency) = %{version}

%description
go-resiliency implements resiliency patterns for Go, including
breaker, retrier, deadline, semaphore, and batcher helpers.
