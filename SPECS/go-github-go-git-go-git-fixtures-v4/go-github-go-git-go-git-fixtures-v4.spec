...
Version:        4.3.1.20231010+git55a9409
Release:        %autorelease
...
BuildOption(prep):  -n go-git-fixtures-55a94097c399cd93043103aa276a733b91537b0b
...
Provides:       go(github.com/go-git/go-git-fixtures/v4/internal/tgz) = %{version}
