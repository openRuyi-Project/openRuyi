...
BuildOption(conf):  --with-banner-add="/openRuyi"
...
# Don't know if we ca enable LuaJIT here?
#ifarch riscv64
#BuildOption(conf):  --disable-luajittex
#BuildOption(conf):  --disable-luajithbtex
#BuildOption(conf):  --disable-mfluajit
#BuildOption(conf):  --disable-mfluajit-nowin
#endif
# Use system psutils
BuildOption(conf):  --disable-psutils
