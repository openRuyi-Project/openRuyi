...
Source0:        https://github.com/pjbgf/sha1cd/archive/refs/tags/v0.6.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
...
Provides:       go(github.com/pjbgf/sha1cd/cgo) = %{version}
Provides:       go(github.com/pjbgf/sha1cd/internal) = %{version}
Provides:       go(github.com/pjbgf/sha1cd/test) = %{version}
Provides:       go(github.com/pjbgf/sha1cd/ubc) = %{version}
