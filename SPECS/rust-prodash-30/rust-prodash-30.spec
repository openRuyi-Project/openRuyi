...
%global pkgname prodash-30

Name:           rust-prodash-30
Version:        30.0.1
Release:        %autorelease
...
Provides:       crate(%{pkgname}/bytesize) = %{version}
Provides:       crate(%{pkgname}/unit-bytes) = %{version}
...
Provides:       crate(%{pkgname}/crosstermion) = %{version}
...
Provides:       crate(%{pkgname}/ctrlc) = %{version}
...
Provides:       crate(%{pkgname}/progress-tree-hp-hashmap) = %{version}
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(human-format-1/default) >= 1.0.3
Provides:       crate(%{pkgname}/human-format) = %{version}
Provides:       crate(%{pkgname}/unit-human) = %{version}
...
Provides:       crate(%{pkgname}/render-line-autoconfigure) = %{version}
...
Provides:       crate(%{pkgname}/unit-duration) = %{version}
...
Provides:       crate(%{pkgname}/progress-log) = %{version}
Provides:       crate(%{pkgname}/progress-tree-log) = %{version}
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(parking-lot-0.12) >= 0.12.1
...
Provides:       crate(%{pkgname}/render-line) = %{version}
...
Provides:       crate(%{pkgname}/render-line-crossterm) = %{version}
...
Requires:       crate(%{pkgname}/jiff) = %{version}
Requires:       crate(%{pkgname}/tui) = %{version}
Requires:       crate(%{pkgname}/tui-react) = %{version}
Requires:       crate(%{pkgname}/unicode-segmentation) = %{version}
Requires:       crate(%{pkgname}/unicode-width) = %{version}
Requires:       crate(crosstermion-0.14/input-async) >= 0.14.0
Provides:       crate(%{pkgname}/render-tui) = %{version}
...
Provides:       crate(%{pkgname}/render-tui-crossterm) = %{version}
...
Provides:       crate(%{pkgname}/tui) = %{version}
...
Provides:       crate(%{pkgname}/tui-react) = %{version}
