...
%global pkgname clap-complete-nushell-4

Name:           rust-clap-complete-nushell-4
Version:        4.6.0
Release:        %autorelease
...
Requires:       crate(clap-complete-4/default) >= 4.5.51
...
Requires:       crate(completest-nu-1/default) >= 1.0.0
