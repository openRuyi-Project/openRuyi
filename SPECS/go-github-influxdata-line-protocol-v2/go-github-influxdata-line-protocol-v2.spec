...
Source0:        https://github.com/influxdata/line-protocol/archive/refs/tags/v2.2.1.tar.gz#/%{_name}-%{version}.tar.gz
Patch0:         2000-disable-corpus-test-bootstrap-cycle.patch
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n line-protocol-2.2.1
...
Provides:       go(github.com/influxdata/line-protocol/v2/lineprotocol) = %{version}
