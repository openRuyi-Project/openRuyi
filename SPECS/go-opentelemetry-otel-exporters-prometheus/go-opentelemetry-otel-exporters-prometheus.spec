...
Source0:        https://github.com/open-telemetry/opentelemetry-go/archive/refs/tags/exporters/prometheus/v0.65.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-go-exporters-prometheus-v0.65.0
...
Provides:       go(go.opentelemetry.io/otel/exporters/prometheus/internal) = %{version}
Provides:       go(go.opentelemetry.io/otel/exporters/prometheus/internal/counter) = %{version}
Provides:       go(go.opentelemetry.io/otel/exporters/prometheus/internal/observ) = %{version}
Provides:       go(go.opentelemetry.io/otel/exporters/prometheus/internal/x) = %{version}
