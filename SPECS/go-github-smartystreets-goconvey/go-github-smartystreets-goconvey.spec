...
# Backport the stack-trace portion of this upstream fix; the other files do not
# apply to the packaged release.
# https://github.com/smartystreets/goconvey/commit/f5ff3631b389ef348682e0271468340db5cfe0e1
Patch1000:      1000-convey-count-only-goroutine-stack-headers.patch
