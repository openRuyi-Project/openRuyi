...
%global full_version 0.34.2
%global pkgname nalgebra-0.34

Name:           rust-nalgebra-0.34
Version:        0.34.2
Release:        %autorelease
Summary:        Rust crate "nalgebra"
License:        Apache-2.0
URL:            https://nalgebra.rs
#!RemoteAsset:  sha256:df76ea0ff5c7e6b88689085804d6132ded0ddb9de5ca5b8aeb9eeadc0508a70a
...
Summary:        General-purpose linear algebra library with transformations and statically-sized or dynamically-sized matrices - feature "defmt"
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(defmt-1/default) >= 1.0.1
Provides:       crate(%{pkgname}/defmt) = %{version}

%description -n %{name}+defmt
This metapackage enables feature "defmt" for the Rust nalgebra crate, by pulling in any additional dependencies needed by that feature.

%package     -n %{name}+encase
Summary:        General-purpose linear algebra library with transformations and statically-sized or dynamically-sized matrices - feature "encase"
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(encase-0.12/default) >= 0.12.0
Provides:       crate(%{pkgname}/encase) = %{version}

%description -n %{name}+encase
This metapackage enables feature "encase" for the Rust nalgebra crate, by pulling in any additional dependencies needed by that feature.
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.14) >= 0.14.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.15) >= 0.15.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.16) >= 0.16.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.17) >= 0.17.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.18) >= 0.18.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.19) >= 0.19.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.20) >= 0.20.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.21) >= 0.21.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.22) >= 0.22.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.23) >= 0.23.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.24) >= 0.24.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.25) >= 0.25.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.27) >= 0.27.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.28) >= 0.28.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.29) >= 0.29.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.30) >= 0.30.0
...
%package     -n %{name}+glam031
Summary:        General-purpose linear algebra library with transformations and statically-sized or dynamically-sized matrices - feature "glam031" and 1 more
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.31) >= 0.31.0
Provides:       crate(%{pkgname}/convert-glam031) = %{version}
Provides:       crate(%{pkgname}/glam031) = %{version}

%description -n %{name}+glam031
This metapackage enables feature "glam031" for the Rust nalgebra crate, by pulling in any additional dependencies needed by that feature.

Additionally, this package also provides the "convert-glam031" feature.

%package     -n %{name}+glam032
Summary:        General-purpose linear algebra library with transformations and statically-sized or dynamically-sized matrices - feature "glam032" and 1 more
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.32) >= 0.32.0
Provides:       crate(%{pkgname}/convert-glam032) = %{version}
Provides:       crate(%{pkgname}/glam032) = %{version}

%description -n %{name}+glam032
This metapackage enables feature "glam032" for the Rust nalgebra crate, by pulling in any additional dependencies needed by that feature.

Additionally, this package also provides the "convert-glam032" feature.
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(glam-0.14/libm) >= 0.14.0
Requires:       crate(glam-0.15/libm) >= 0.15.0
Requires:       crate(glam-0.16/libm) >= 0.16.0
Requires:       crate(glam-0.17/libm) >= 0.17.0
Requires:       crate(glam-0.18/libm) >= 0.18.0
Requires:       crate(glam-0.19/libm) >= 0.19.0
Requires:       crate(glam-0.20/libm) >= 0.20.0
Requires:       crate(glam-0.21/libm) >= 0.21.0
Requires:       crate(glam-0.22/libm) >= 0.22.0
Requires:       crate(glam-0.23/libm) >= 0.23.0
Requires:       crate(glam-0.24/libm) >= 0.24.0
Requires:       crate(glam-0.25/libm) >= 0.25.0
Requires:       crate(glam-0.27/libm) >= 0.27.0
Requires:       crate(glam-0.28/libm) >= 0.28.0
Requires:       crate(glam-0.29/libm) >= 0.29.0
Requires:       crate(glam-0.30/libm) >= 0.30.0
Requires:       crate(glam-0.31/libm) >= 0.31.0
Requires:       crate(glam-0.32/libm) >= 0.32.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(nalgebra-macros-0.3/default) >= 0.3.0
...
Requires:       crate(glam-0.14/std) >= 0.14.0
Requires:       crate(glam-0.15/std) >= 0.15.0
Requires:       crate(glam-0.16/std) >= 0.16.0
Requires:       crate(glam-0.17/std) >= 0.17.0
Requires:       crate(glam-0.18/std) >= 0.18.0
Requires:       crate(glam-0.19/std) >= 0.19.0
Requires:       crate(glam-0.20/std) >= 0.20.0
Requires:       crate(glam-0.21/std) >= 0.21.0
Requires:       crate(glam-0.22/std) >= 0.22.0
Requires:       crate(glam-0.23/std) >= 0.23.0
Requires:       crate(glam-0.24/std) >= 0.24.0
Requires:       crate(glam-0.25/std) >= 0.25.0
Requires:       crate(glam-0.27/std) >= 0.27.0
Requires:       crate(glam-0.28/std) >= 0.28.0
Requires:       crate(glam-0.29/std) >= 0.29.0
Requires:       crate(glam-0.30/std) >= 0.30.0
Requires:       crate(glam-0.31/std) >= 0.31.0
Requires:       crate(glam-0.32/std) >= 0.32.0
