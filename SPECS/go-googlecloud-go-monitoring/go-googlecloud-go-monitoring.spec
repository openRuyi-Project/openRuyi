...
Source0:        https://github.com/googleapis/google-cloud-go/archive/refs/tags/monitoring/v1.29.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n google-cloud-go-monitoring-v1.29.0
...
Provides:       go(cloud.google.com/go/monitoring/apiv3) = %{version}
Provides:       go(cloud.google.com/go/monitoring/apiv3/v2) = %{version}
Provides:       go(cloud.google.com/go/monitoring/apiv3/v2/monitoringpb) = %{version}
Provides:       go(cloud.google.com/go/monitoring/dashboard/apiv1) = %{version}
Provides:       go(cloud.google.com/go/monitoring/dashboard/apiv1/dashboardpb) = %{version}
Provides:       go(cloud.google.com/go/monitoring/internal) = %{version}
Provides:       go(cloud.google.com/go/monitoring/metricsscope/apiv1) = %{version}
Provides:       go(cloud.google.com/go/monitoring/metricsscope/apiv1/metricsscopepb) = %{version}
