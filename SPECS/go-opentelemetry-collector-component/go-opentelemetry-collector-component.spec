...
Source0:        https://github.com/open-telemetry/opentelemetry-collector/archive/refs/tags/component/v1.58.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-collector-component-v1.58.0/component
...
BuildRequires:  go(go.opentelemetry.io/collector/pdata/pcommon)
...
Requires:       go(go.opentelemetry.io/collector/pdata/pcommon)
