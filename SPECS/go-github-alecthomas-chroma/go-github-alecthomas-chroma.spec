...
# Generated lexer tables intentionally use unkeyed Rule struct literals.
...
# The two command trees are independent modules and are not reached by the
# root module's default ./... check.
for module in cmd/chroma cmd/chromad; do
