...
Source0:        https://github.com/GoogleCloudPlatform/opentelemetry-operations-go/archive/refs/tags/detectors/gcp/v1.32.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-operations-go-detectors-gcp-v1.32.0
...
%description
This package provides GCP resource detector for OpenTelemetry.
