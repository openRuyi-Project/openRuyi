...
%global pkgname schemars-0.9

Name:           rust-schemars-0.9
Version:        0.9.0
Release:        %autorelease
Summary:        Rust crate "schemars"
License:        MIT
URL:            https://graham.cool/schemars/
#!RemoteAsset:  sha256:4cd191f9397d57d581cddd31014772520aa448f65ef991055d7f61582c65165f
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(schemars-derive-0.9/default) >= 0.9.0
