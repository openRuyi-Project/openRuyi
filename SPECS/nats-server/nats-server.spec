...
# https://github.com/nats-io/nats-server/commit/747ff4914a11f91be31306673cab3be23eb5a0b1
Patch1015:      1015-release-stream-locks-in-interest-test.patch
# https://github.com/nats-io/nats-server/commit/5a0caf2b272ef9dc38832c7530643bbd35963061
Patch1016:      1016-use-atomic-consumer-create-api-in-test.patch
# https://github.com/nats-io/nats-server/commit/d6a8e026bc35df9943cc2d30767cd76bc8e4b4c4
Patch1017:      1017-report-ephemeral-publish-errors-in-test-goroutine.patch
...
# Wait for restarted replicas to catch up before comparing snapshot state.
Patch2017:      2017-wait-for-restarted-stream-replicas.patch
# Inject a write timeout only after the leaf has completed CONNECT.
Patch2018:      2018-inject-leaf-slow-consumer-timeout.patch
# Bound and join all replicated publishes before ephemeral test cleanup.
Patch2019:      2019-join-ephemeral-test-publisher.patch
# Handle server heartbeats while installing all 100,000 route subscriptions.
Patch2020:      2020-handle-heartbeats-during-route-subscription-test.patch
# Wait for actual leaf subscriptions instead of matching local wildcard interest.
Patch2021:      2021-wait-for-remote-leaf-permission-subscriptions.patch
# Exercise periodic interest cleanup before the regression test deadline.
Patch2022:      2022-run-periodic-interest-cleanup-within-test-window.patch
# Subscribe to API-limit advisories before generating the finite request burst.
Patch2023:      2023-wait-for-api-limit-advisory-subscriptions.patch
# Finish clean-session Will delivery before checking retained-message permissions.
Patch2024:      2024-wait-for-mqtt-will-session-cleanup.patch
# Exercise orphan-peer cleanup within the leaf-spoke membership test deadline.
Patch2025:      2025-run-peer-expiry-within-leaf-spoke-test-window.patch
