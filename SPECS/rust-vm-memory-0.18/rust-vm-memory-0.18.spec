...
%global pkgname vm-memory-0.18

Name:           rust-vm-memory-0.18
Version:        0.18.0
Release:        %autorelease
Summary:        Rust crate "vm-memory"
License:        Apache-2.0 OR BSD-3-Clause
URL:            https://github.com/rust-vmm/vm-memory
#!RemoteAsset:  sha256:9b55e753c7725603745cb32b2287ef7ef3da05c03c7702cda3fa8abe25ae0465
...
%description
Source code for the Rust crate "vm-memory"
...
%package     -n %{name}+iommu
Summary:        Safe abstractions for accessing the VM physical memory - feature "iommu"
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(rangemap-1/default) >= 1.5.1
Provides:       crate(%{pkgname}/iommu) = %{version}

%description -n %{name}+iommu
This metapackage enables feature "iommu" for the Rust vm-memory crate, by pulling in any additional dependencies needed by that feature.
