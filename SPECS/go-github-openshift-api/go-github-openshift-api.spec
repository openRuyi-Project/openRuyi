...
# The envtest suite requires external kubebuilder control-plane assets.
...
# Fix non-constant format strings in code-generation tools for current Go vet.
...
# Use the distribution dependencies instead of shipping vendored copies.
