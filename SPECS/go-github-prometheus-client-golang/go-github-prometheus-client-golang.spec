...
Provides:       go(github.com/prometheus/client_golang/exp) = %{version}
Provides:       go(github.com/prometheus/client_golang/prometheus) = %{version}
Provides:       go(github.com/prometheus/client_golang/prometheus/push) = %{version}
