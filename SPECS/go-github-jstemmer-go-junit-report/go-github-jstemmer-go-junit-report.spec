...
Source0:        https://github.com/jstemmer/go-junit-report/archive/refs/tags/v1.0.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n go-junit-report-1.0.0
...
%description
This package provides Go test output to JUnit XML converter.
