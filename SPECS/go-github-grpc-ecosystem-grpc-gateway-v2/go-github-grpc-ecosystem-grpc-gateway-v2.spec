...
Source0:        https://github.com/grpc-ecosystem/grpc-gateway/archive/refs/tags/v2.29.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n grpc-gateway-2.29.0
...
%description
This package provides gRPC to JSON proxy generator for Go.
