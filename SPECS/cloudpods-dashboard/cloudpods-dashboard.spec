...
# TODO: Replace this build-tool source with the openRuyi Yarn package once available.
...
%check
# Webpack 4 uses the legacy MD4 digest while loading the unit-test toolchain.
