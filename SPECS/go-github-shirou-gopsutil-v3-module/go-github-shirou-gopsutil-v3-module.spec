...
# The conventional RPM name is already used by the legacy unversioned module.
# Keep this source package distinct while providing the canonical import path.
# CPU per-core counts and swap devices are not stable in the OBS container.
%define go_test_exclude %{shrink:
    github.com/shirou/gopsutil/v3/cpu
    github.com/shirou/gopsutil/v3/mem
}

Name:           go-github-shirou-gopsutil-v3-module
Version:        3.22.12
Release:        %autorelease
