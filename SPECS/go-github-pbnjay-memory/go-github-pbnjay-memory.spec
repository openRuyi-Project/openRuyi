...
BuildOption(prep):  -n memory-7b4eea64cf580186c0eceb10dc94ba3a098af46c
...
This package has no external dependency besides the standard library and
default operating system tools.

Documentation: [Image: GoDoc]
(https://godoc.org/github.com/pbnjay/memory?status.svg)
