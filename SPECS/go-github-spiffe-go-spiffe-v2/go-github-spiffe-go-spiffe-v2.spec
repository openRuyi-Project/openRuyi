...
Source0:        https://github.com/spiffe/go-spiffe/archive/refs/tags/v2.6.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n go-spiffe-2.6.0
...
# packages whose tests import them.
