...
Source0:        https://github.com/skeema/knownhosts/archive/refs/tags/v1.3.2.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
...
BuildRequires:  go(golang.org/x/crypto/ssh/knownhosts)

Provides:       go(github.com/skeema/knownhosts) = %{version}

Requires:       go(golang.org/x/crypto)
Requires:       go(golang.org/x/crypto/ssh)
Requires:       go(golang.org/x/crypto/ssh/knownhosts)
