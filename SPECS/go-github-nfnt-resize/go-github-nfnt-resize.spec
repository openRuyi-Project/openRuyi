...
%description
This package is no longer being updated! Please look for alternatives if
that bothers you.

Resize

Image resizing for the Go programming language (http://golang.org) with
common interpolation methods.

[Image: Build Status] (https://travis-ci.org/nfnt/resize.svg)
