...
#!RemoteAsset:  sha256:edca88bc138befd0323b20752846e6587272d3b03b0343c8ea28a6f819e6e71f
...
Requires:       crate(async-trait-0.1/default) >= 0.1.67
Requires:       crate(axum-core-0.4/default) >= 0.4.5
...
Requires:       crate(matchit-0.7/default) >= 0.7.0
...
Requires:       crate(rustversion-1/default) >= 1.0.9
Requires:       crate(serde-1/default) >= 1.0.0
Requires:       crate(sync-wrapper-1/default) >= 1.0.0
Requires:       crate(tower-0.5/util) >= 0.5.1
...
Requires:       crate(axum-core-0.4/private-docs) >= 0.4.5
Requires:       crate(tower-0.5/full) >= 0.5.1
Requires:       crate(tower-0.5/util) >= 0.5.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(axum-macros-0.4/default) >= 0.4.2
...
Requires:       crate(tokio-1/net) >= 1.25.0
Requires:       crate(tokio-1/rt) >= 1.25.0
Requires:       crate(tokio-1/time) >= 1.25.0
Requires:       crate(tower-0.5/make) >= 0.5.1
Requires:       crate(tower-0.5/util) >= 0.5.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(tower-0.5/log) >= 0.5.1
Requires:       crate(tower-0.5/util) >= 0.5.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(axum-core-0.4/tracing) >= 0.4.5
...
Requires:       crate(tokio-tungstenite-0.24/default) >= 0.24.0
