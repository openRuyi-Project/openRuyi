...
Source0:        https://github.com/googleapis/google-cloud-go/archive/refs/tags/compute/v1.63.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n google-cloud-go-compute-v1.63.0
...
Provides:       go(cloud.google.com/go/compute/apiv1) = %{version}
Provides:       go(cloud.google.com/go/compute/apiv1/computepb) = %{version}
Provides:       go(cloud.google.com/go/compute/apiv1beta) = %{version}
Provides:       go(cloud.google.com/go/compute/apiv1beta/computepb) = %{version}
Provides:       go(cloud.google.com/go/compute/internal) = %{version}
...
%description
This package provides Compute client libraries for Google Cloud Go.
...
set +f
test -n "${_go_filtered}"
# The apiv1 smoke tests call real Google Cloud APIs and fail in OBS with
# "credentials: could not find default credentials".
go test -v -skip 'TestCreateGetPutPatchListInstance|TestCreateGetRemoveSecurityPolicies|TestPaginationWithMaxRes|TestPaginationDefault|TestPaginationMapResponse|TestPaginationMapResponseMaxRes|TestInstanceGroupResize' ${_go_filtered}
popd
