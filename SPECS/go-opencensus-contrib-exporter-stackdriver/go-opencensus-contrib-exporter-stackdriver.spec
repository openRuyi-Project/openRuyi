...
BuildOption(prep):  -n opencensus-go-exporter-stackdriver-0.13.14
...
# Stackdriver clients in OBS; subpackage tests still run.
...
Provides:       go(contrib.go.opencensus.io/exporter/stackdriver/internal/testpb) = %{version}
Provides:       go(contrib.go.opencensus.io/exporter/stackdriver/monitoredresource) = %{version}
Provides:       go(contrib.go.opencensus.io/exporter/stackdriver/monitoredresource/aws) = %{version}
Provides:       go(contrib.go.opencensus.io/exporter/stackdriver/monitoredresource/gcp) = %{version}
Provides:       go(contrib.go.opencensus.io/exporter/stackdriver/propagation) = %{version}
