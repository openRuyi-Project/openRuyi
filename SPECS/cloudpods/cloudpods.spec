...
accounts, and on-premises virtualization through a consistent API. The main
package is a convenience package that installs the command-line client and
privileged host executor needed for initial openRuyi integration.
...
%files cli
%doc cmd/climc/README.md vendor/modules.txt
%license LICENSE
%{_bindir}/climc
