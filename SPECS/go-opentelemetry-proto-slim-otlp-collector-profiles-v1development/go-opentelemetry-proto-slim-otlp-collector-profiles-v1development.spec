...
Version:        0.3.0
Release:        %autorelease
Summary:        Go library for go.opentelemetry.io/proto/slim/otlp/collector/profiles/v1development
License:        Apache-2.0
...
Source0:        https://github.com/open-telemetry/opentelemetry-proto-go/archive/refs/tags/slim/otlp/collector/profiles/v1development/v0.3.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-proto-go-slim-otlp-collector-profiles-v1development-v0.3.0/slim/otlp/collector/profiles/v1development
