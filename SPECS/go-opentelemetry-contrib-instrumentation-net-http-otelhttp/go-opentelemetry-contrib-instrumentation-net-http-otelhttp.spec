...
%define _name           otelhttp
%define go_import_path  go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp
%define go_source_subdir instrumentation/net/http/otelhttp

Name:           go-opentelemetry-contrib-instrumentation-net-http-otelhttp
Version:        0.68.0
Release:        %autorelease
...
Source0:        https://github.com/open-telemetry/opentelemetry-go-contrib/archive/refs/tags/instrumentation/net/http/otelhttp/v0.68.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-go-contrib-instrumentation-net-http-otelhttp-v0.68.0
...
Provides:       go(go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp/filters) = %{version}
Provides:       go(go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp/internal/request) = %{version}
Provides:       go(go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp/internal/semconv) = %{version}
...
# OBS currently behaves like httpmuxgo121=1 unless this is forced.
