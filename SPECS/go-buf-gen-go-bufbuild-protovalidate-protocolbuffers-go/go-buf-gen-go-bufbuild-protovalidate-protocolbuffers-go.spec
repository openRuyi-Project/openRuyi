...
# Buf publishes this generated module through the Go proxy without a matching
# VCS tag or source archive. There is no simple way to generate it directly.
...
%prep
# Go proxy ZIPs store module contents below an import-path@version directory.
%setup -q -c -T
unzip -q %{SOURCE0}
