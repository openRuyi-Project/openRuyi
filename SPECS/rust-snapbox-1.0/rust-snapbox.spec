...
Requires:       crate(snapbox-macros-1.0/default) >= 1.0.0
...
Requires:       crate(snapbox-macros-1.0/color) >= 1.0.0
...
Requires:       crate(snapbox-macros-1.0/debug) >= 1.0.0
...
Requires:       crate(dunce-1.0/default) >= 1.0.0
Requires:       crate(filetime-0.2/default) >= 0.2.26
Requires:       crate(tempfile-3.0/default) >= 3.23
...
Requires:       crate(%{pkgname})
Requires:       crate(regex-1.0/std) >= 1.11.3
