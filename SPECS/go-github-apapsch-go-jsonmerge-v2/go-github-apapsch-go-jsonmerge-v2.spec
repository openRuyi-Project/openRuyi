...
Source0:        https://github.com/apapsch/go-jsonmerge/archive/refs/tags/v2.0.0.tar.gz#/%{_name}-%{version}.tar.gz
...
Provides:       go(github.com/apapsch/go-jsonmerge/v2/cmd/jsonmerge/options) = %{version}
...
[Image: Build Status] (https://travis-ci.org/RaveNoX/go-
jsonmerge.svg?branch=master) (https://travis-ci.org/RaveNoX/go-
jsonmerge)
[Image: GoDoc] (https://godoc.org/github.com/RaveNoX/go-
jsonmerge?status.svg) (https://godoc.org/github.com/RaveNoX/go-
jsonmerge)
