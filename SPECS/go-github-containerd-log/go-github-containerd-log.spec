...
Source0:        https://github.com/containerd/log/archive/refs/tags/v0.1.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n log-0.1.0
...
Provides:       go(github.com/containerd/log/logtest) = %{version}
