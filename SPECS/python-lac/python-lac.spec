...
Patch2000:      2000-setup.py-avoid-importing-paddle-at-build-time.patch
# Support the non-fluid Paddle runtime provided by current openRuyi.
Patch2001:      2001-support-paddle-base-runtime.patch
...
Provides:       python3-lac = %{version}-%{release}
%python_provide python3-lac
...
%check
# Avoid duplicating python-paddlepaddle's transitive runtime dependency closure here.
%{python3} -m compileall -q %{srcname}
