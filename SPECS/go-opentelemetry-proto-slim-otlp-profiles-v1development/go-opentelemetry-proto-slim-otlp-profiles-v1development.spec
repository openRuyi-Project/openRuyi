...
Version:        0.3.0
Release:        %autorelease
Summary:        Go library for go.opentelemetry.io/proto/slim/otlp/profiles/v1development
License:        Apache-2.0
...
Source0:        https://github.com/open-telemetry/opentelemetry-proto-go/archive/refs/tags/slim/otlp/profiles/v1development/v0.3.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-proto-go-slim-otlp-profiles-v1development-v0.3.0/slim/otlp/profiles/v1development
...
BuildRequires:  go(go.opentelemetry.io/proto/slim/otlp/common/v1)
BuildRequires:  go(go.opentelemetry.io/proto/slim/otlp/resource/v1)
...
Requires:       go(go.opentelemetry.io/proto/slim/otlp/common/v1)
Requires:       go(go.opentelemetry.io/proto/slim/otlp/resource/v1)
