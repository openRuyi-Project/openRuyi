...
Version:        1.0.4
Release:        %autorelease
Summary:        Stringprep and SASLprep for Go
License:        Apache-2.0
...
Provides:       go(github.com/xdg-go/stringprep) = %{version}

Requires:       go(golang.org/x/text)

%description
Stringprep implements RFC 3454 string preparation, including the RFC 4013
SASLprep profile used for authentication strings.
