...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(%{pkgname}/schemars08) = %{version}
Requires:       crate(%{pkgname}/serde) = %{version}
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(schemars-1) >= 1.0.0
Provides:       crate(%{pkgname}/schemars1) = %{version}
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(heapless-0.0.0/default) >= 0.0.0
Provides:       crate(%{pkgname}/ser-as-str) = %{version}
