...
Source0:        https://github.com/santhosh-tekuri/jsonschema/archive/refs/tags/v5.3.1.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
...
Provides:       go(github.com/santhosh-tekuri/jsonschema/v5/httploader) = %{version}
