...
Requires:       crate(num-bigint-0.4) >= 0.4.5
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(num-bigint-0.4/rand) >= 0.4.5
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(num-bigint-0.4/serde) >= 0.4.5
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(num-bigint-0.4) >= 0.4.5
Requires:       crate(num-bigint-0.4/std) >= 0.4.5
