...
# Keep the architecture-dependent generator binary separate from the Go source
# package.
%package -n enumer
Summary:        Enum method generator for Go
...
%check
# Exercise the installed generator against its representative Go module fixture.
