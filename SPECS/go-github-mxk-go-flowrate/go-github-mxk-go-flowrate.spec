...
Provides:       go(github.com/mxk/go-flowrate/flowrate) = %{version}


%description
go-flowrate provides reader and writer wrappers that can measure and limit
data transfer rates. Kubernetes apimachinery uses this package in transport
and stream handling code that needs throughput accounting.
