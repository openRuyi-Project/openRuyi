...
Source0:        https://github.com/googleapis/google-cloud-go/archive/refs/tags/logging/v1.18.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n google-cloud-go-logging-v1.18.0
...
# can be built, so exclude the logadmin package only for this bootstrap check.
...
Provides:       go(cloud.google.com/go/logging/apiv2) = %{version}
Provides:       go(cloud.google.com/go/logging/apiv2/loggingpb) = %{version}
Provides:       go(cloud.google.com/go/logging/internal) = %{version}
Provides:       go(cloud.google.com/go/logging/internal/testing) = %{version}
Provides:       go(cloud.google.com/go/logging/logadmin) = %{version}
