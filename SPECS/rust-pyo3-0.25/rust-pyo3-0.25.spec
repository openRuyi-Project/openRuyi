...
#!RemoteAsset:  sha256:8970a78afe0628a3e3430376fc5fd76b6b45c4d43360ffd6cdd40bdde72b682a
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(bigdecimal-0.4/default) >= 0.4.0
...
Requires:       crate(pyo3-macros-0.25/experimental-async) >= 0.25.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-macros-0.25/experimental-inspect) >= 0.25.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-ffi-0.25/extension-module) >= 0.25.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-ffi-0.25/generate-import-lib) >= 0.25.1
...
Requires:       crate(pyo3-macros-0.25/multiple-pymethods) >= 0.25.1
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-macros-0.25/default) >= 0.25.1
