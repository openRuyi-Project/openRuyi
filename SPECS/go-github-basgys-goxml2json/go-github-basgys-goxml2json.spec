...
Source0:        https://github.com/basgys/goxml2json/archive/refs/tags/v1.1.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n goxml2json-1.1.0

BuildRequires:  go
BuildRequires:  go-rpm-macros
BuildRequires:  go(github.com/bitly/go-simplejson)
BuildRequires:  go(github.com/stretchr/testify/assert)
BuildRequires:  go(golang.org/x/net/html/charset)

Provides:       go(github.com/basgys/goxml2json) = %{version}

Requires:       go(golang.org/x/net/html/charset)


%description
goxml2json [Image: CircleCI]
(https://circleci.com/gh/basgys/goxml2json.svg?style=svg)
(https://circleci.com/gh/basgys/goxml2json)
