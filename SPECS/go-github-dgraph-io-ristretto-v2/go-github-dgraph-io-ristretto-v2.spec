...
# The riscv64 mremap syscall does not provide the mapping size in its second
# return value, so use the existing size-independent implementation there.
Patch2000:      2000-tests-skip-persistent-mmap-growth-on-riscv64.patch
