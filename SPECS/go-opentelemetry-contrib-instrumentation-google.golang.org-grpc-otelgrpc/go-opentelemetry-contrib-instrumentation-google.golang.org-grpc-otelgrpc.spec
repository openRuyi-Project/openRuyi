...
%define _name           otelgrpc
%define go_import_path  go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc
%define go_source_subdir instrumentation/google.golang.org/grpc/otelgrpc

Name:           go-opentelemetry-contrib-instrumentation-google.golang.org-grpc-otelgrpc
Version:        0.68.0
Release:        %autorelease
Summary:        Go library for go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc
License:        Apache-2.0
URL:            https://github.com/open-telemetry/opentelemetry-go-contrib
#!RemoteAsset:  sha256:b3d7ea4bc31fa1be9848cf534dc3887734ec7fa80298c95aa97f3ccc5a24d962
Source0:        https://github.com/open-telemetry/opentelemetry-go-contrib/archive/refs/tags/instrumentation/google.golang.org/grpc/otelgrpc/v0.68.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-go-contrib-instrumentation-google.golang.org-grpc-otelgrpc-v0.68.0
...
Provides:       go(go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc/filters) = %{version}
Provides:       go(go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc/internal) = %{version}
Provides:       go(go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc/internal/test) = %{version}
...
%description
This package provides the Go library go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc.
