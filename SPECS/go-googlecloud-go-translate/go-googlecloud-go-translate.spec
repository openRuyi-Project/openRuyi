...
%define _name           translate
%define go_import_path  cloud.google.com/go/translate
%define go_source_subdir translate

Name:           go-googlecloud-go-translate
Version:        1.17.0
Release:        %autorelease
Summary:        Go library for cloud.google.com/go/translate
License:        Apache-2.0
URL:            https://github.com/googleapis/google-cloud-go
#!RemoteAsset:  sha256:aaba22cb284888acc31582a6f148eae42538efdd495402cb6686d1223f615c8b
Source0:        https://github.com/googleapis/google-cloud-go/archive/refs/tags/translate/v1.17.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n google-cloud-go-translate-v1.17.0
# The explicit %%install/%%check sections below enter %%{go_source_subdir};
# using BuildOption(prep): -n .../translate would place the module contents at
...
Provides:       go(cloud.google.com/go/translate) = %{version}
Provides:       go(cloud.google.com/go/translate/apiv3) = %{version}
Provides:       go(cloud.google.com/go/translate/apiv3/translatepb) = %{version}
Provides:       go(cloud.google.com/go/translate/internal) = %{version}
...
%description
This package provides the Go library cloud.google.com/go/translate.
...
# translate imports cloud.google.com/go/internal/version. Keep the module and
