...
Source0:        https://github.com/open-telemetry/opentelemetry-go-contrib/archive/refs/tags/detectors/gcp/v1.43.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

BuildOption(prep):  -n opentelemetry-go-contrib-detectors-gcp-v1.43.0
...
%description
This package provides GCP resource detector for OpenTelemetry Go.
