...
# The parseutil tag supplies parseutil and strutil, while the newer awsutil tag
# supplies awsutil. Each directory is an independently versioned Go module.
...
%prep
# Combine the independently tagged module trees into their canonical paths.
%setup -q -c -T -a 0
%setup -q -D -T -a 1
