...
# Go compiler closure suffixes differ between releases; keep checking frame
# origin and source lines without requiring an implementation-specific name.
Patch2000:      2000-avoid-compiler-specific-nested-function-names.patch
