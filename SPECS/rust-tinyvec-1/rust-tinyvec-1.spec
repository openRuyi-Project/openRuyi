...
Provides:       crate(%{pkgname}/experimental-write-impl) = %{version}
Provides:       crate(%{pkgname}/grab-spare-slice) = %{version}
Provides:       crate(%{pkgname}/latest-stable-rust) = %{version}
Provides:       crate(%{pkgname}/nightly-slice-partition-dedup) = %{version}
Provides:       crate(%{pkgname}/real-blackbox) = %{version}
Provides:       crate(%{pkgname}/rustc-1-40) = %{version}
Provides:       crate(%{pkgname}/rustc-1-55) = %{version}
Provides:       crate(%{pkgname}/rustc-1-57) = %{version}
Provides:       crate(%{pkgname}/rustc-1-61) = %{version}
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(generic-array-1) >= 1.1.1
...
Provides:       crate(%{pkgname}/tinyvec-macros) = %{version}
