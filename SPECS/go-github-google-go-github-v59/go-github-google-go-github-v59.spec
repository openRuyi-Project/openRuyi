...
Source0:        https://github.com/google/go-github/archive/refs/tags/v59.0.0.tar.gz#/%{_name}-%{version}.tar.gz
BuildArch:      noarch
BuildSystem:    golangmodules

# Some build environments map .txt to the generic application/octet-stream
...
BuildOption(prep):  -n go-github-59.0.0
...
BuildRequires:  go(github.com/google/go-querystring/query)

Provides:       go(github.com/google/go-github/v59) = %{version}
Provides:       go(github.com/google/go-github/v59/github) = %{version}
Provides:       go(github.com/google/go-github/v59/test/integration) = %{version}

Requires:       go(github.com/google/go-querystring)
Requires:       go(github.com/google/go-querystring/query)
