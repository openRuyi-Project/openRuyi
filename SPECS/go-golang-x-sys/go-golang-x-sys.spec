...
Provides:       go(golang.org/x/sys/cpu) = %{version}
Provides:       go(golang.org/x/sys/execabs) = %{version}
Provides:       go(golang.org/x/sys/unix) = %{version}
Provides:       go(golang.org/x/sys/windows) = %{version}
